...
class MQTTSession: MQTTSessionStreamDelegate {
    ...
    init(host: String, port: UInt16, clientID: String, cleanSession: Bool, keepAlive: UInt16, useSSL: Bool = false) {
    ...
    func subscribe(to topic: String, delivering qos: MQTTQoS, completion: MQTTSessionCompletionBlock?) {
    ...
    func unSubscribe(from topic: String, completion: MQTTSessionCompletionBlock?) {
